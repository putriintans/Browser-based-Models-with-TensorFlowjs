...
function getModel() {
    ...
    model.add(tf.layers.conv2d({
        inputShape: [28, 28, 1],      // input shape for Fashion MNIST
        filters: 32,                  // number of filters
        kernelSize: 3,                // size of the filter
    ...
    model.add(tf.layers.flatten());   // flatten to feed into Dense layer
    ...
    model.add(tf.layers.dense({
        units: 10,                    // output units for 10 classes
        activation: 'softmax'         // softmax for classification
    }));
